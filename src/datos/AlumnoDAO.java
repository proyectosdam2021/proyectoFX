...
public class AlumnoDAO implements CrudInterface<ClassAlumno> {
    ...
    public boolean insertar(ClassAlumno obj) {
        ...
        try {
            ...
            if (obj.getId_empresa() == 0) {
                ps.setNull(12, java.sql.Types.INTEGER);
            } else {
                ps.setInt(12, obj.getId_empresa()); //asignamos un valor al id_empresa. Este valor se cambiará automaticamente dado que es auto_increment
            }
    ...
    public boolean actualizar(ClassAlumno obj) {
        ...
        try {
            ...
            if (obj.getId_empresa() == 0) {
                ...
                ps.setInt(11, obj.getId_empresa()); //asignamos un valor al id_empresa. Este valor se cambiará automaticamente dado que es auto_increment
            }
